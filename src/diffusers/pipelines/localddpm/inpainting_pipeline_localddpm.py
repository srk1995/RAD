...
class InPaintLocalDDPMPipeline(DiffusionPipeline,
    TextualInversionLoaderMixin,
    StableDiffusionLoraLoaderMixin,
    IPAdapterMixin,
    PeftAdapterMixin,
    ...
    def __call__(
        ...
        image = self.scheduler.add_noise(self.clean_image, torch.randn_like(self.clean_image).to(self.device), timesteps)
